  ...
  return (
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        <div className="uspCard text-center group flex flex-col items-center justify-center">
            <div className="btn-main btn-reveal--top" role='button' aria-label='Additional information button'>
                <span>
                    Find the right drink for you
                </span>
                <div className="btn-arrow relative">
                    <LucideArrowRight className="initial-icon w-4 h-4" />
                    <LucideArrowRight className="hover-icon w-4 h-4" />
                </div>
            </div>
